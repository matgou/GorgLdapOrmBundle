...
class FunctionalTestDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/web/sites/sso.codebykate.com/vendor/gorg/ldaporm-bundle/Gorg/Bundle/LdapOrmBundle/Tests/Functional/cache/test/annotations', true);
    }
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/web/sites/sso.codebykate.com/vendor/gorg/ldaporm-bundle/Gorg/Bundle/LdapOrmBundle/Tests/Functional/Resources');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/web/sites/sso.codebykate.com/vendor/gorg/ldaporm-bundle/Gorg/Bundle/LdapOrmBundle/Tests/Functional/Resources');
    }
    ...
    /**
     * Gets the 'gorg_ldap_orm.entity_manager' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return Gorg\Bundle\LdapOrmBundle\Ldap\LdapEntityManager A Gorg\Bundle\LdapOrmBundle\Ldap\LdapEntityManager instance.
     */
    protected function getGorgLdapOrm_EntityManagerService()
    {
        return $this->services['gorg_ldap_orm.entity_manager'] = new \Gorg\Bundle\LdapOrmBundle\Ldap\LdapEntityManager($this->get('logger'), $this->get('twig'), $this->get('annotation_reader'), array('connection' => array('uri' => 'ldap://host.testcompany.com', 'bind_dn' => 'cn=testuser,dc=testcompany,dc=com', 'password' => 'testPassword', 'use_tls' => false), 'ldap' => array('base_dn' => 'dc=testcompany,dc=com')));
    }
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/web/sites/sso.codebykate.com/vendor/gorg/ldaporm-bundle/Gorg/Bundle/LdapOrmBundle/Tests/Functional/Tests/Functional/config/routing.yml', array('cache_dir' => '/web/sites/sso.codebykate.com/vendor/gorg/ldaporm-bundle/Gorg/Bundle/LdapOrmBundle/Tests/Functional/cache/test', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'FunctionaltestUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'FunctionaltestUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context'), $this->get('monolog.logger.router'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/web/sites/sso.codebykate.com/vendor/gorg/ldaporm-bundle/Gorg/Bundle/LdapOrmBundle/Tests/Functional', 'UTF-8');
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini')), array('cache_dir' => '/web/sites/sso.codebykate.com/vendor/gorg/ldaporm-bundle/Gorg/Bundle/LdapOrmBundle/Tests/Functional/cache/test/translations', 'debug' => true));
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/web/sites/sso.codebykate.com/vendor/gorg/ldaporm-bundle/Gorg/Bundle/LdapOrmBundle/Tests/Functional/cache/test/twig', 'charset' => 'UTF-8', 'debug' => true, 'paths' => array()));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/web/sites/sso.codebykate.com/vendor/gorg/ldaporm-bundle/Gorg/Bundle/LdapOrmBundle/vendor/symfony/twig-bridge/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/web/sites/sso.codebykate.com/vendor/gorg/ldaporm-bundle/Gorg/Bundle/LdapOrmBundle/Tests/Functional/cache/test');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/web/sites/sso.codebykate.com/vendor/gorg/ldaporm-bundle/Gorg/Bundle/LdapOrmBundle/Tests/Functional',
            'kernel.environment' => 'test',
            'kernel.debug' => true,
            'kernel.name' => 'Functional',
            'kernel.cache_dir' => '/web/sites/sso.codebykate.com/vendor/gorg/ldaporm-bundle/Gorg/Bundle/LdapOrmBundle/Tests/Functional/cache/test',
            'kernel.logs_dir' => '/web/sites/sso.codebykate.com/vendor/gorg/ldaporm-bundle/Gorg/Bundle/LdapOrmBundle/Tests/Functional/logs',
            'kernel.bundles' => array(
                'FrameworkBundle' => 'Symfony\\Bundle\\FrameworkBundle\\FrameworkBundle',
                'MonologBundle' => 'Symfony\\Bundle\\MonologBundle\\MonologBundle',
                'TwigBundle' => 'Symfony\\Bundle\\TwigBundle\\TwigBundle',
                'GorgLdapOrmBundle' => 'Gorg\\Bundle\\LdapOrmBundle\\GorgLdapOrmBundle',
            ),
            ...
            'debug.container.dump' => '/web/sites/sso.codebykate.com/vendor/gorg/ldaporm-bundle/Gorg/Bundle/LdapOrmBundle/Tests/Functional/cache/test/FunctionalTestDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Bundle\\FrameworkBundle\\Controller\\TraceableControllerResolver',
            'kernel.secret' => 'secretValue',
            ...
            'router.resource' => '/web/sites/sso.codebykate.com/vendor/gorg/ldaporm-bundle/Gorg/Bundle/LdapOrmBundle/Tests/Functional/Tests/Functional/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/web/sites/sso.codebykate.com/vendor/gorg/ldaporm-bundle/Gorg/Bundle/LdapOrmBundle/Tests/Functional/cache/test/twig',
                'charset' => 'UTF-8',
                'debug' => true,
                'paths' => array(
            ...
            'gorg_ldap_orm.entity_manager.class' => 'Gorg\\Bundle\\LdapOrmBundle\\Ldap\\LdapEntityManager',
            'gorg_ldap_orm.twig_extention.class' => 'Gorg\\Bundle\\LdapOrmBundle\\Twig\\Extension\\LdapFilter',
        );
    }
}
